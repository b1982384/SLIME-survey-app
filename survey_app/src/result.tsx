...
//     1: "Algorithmic Openness - Smart Speaker...waiting for real definitions",
...
//         score: parseFloat(topFactorEntry[1].toString()), // give highest score
...
const ResultsPage = () => {
  ...
  // Mapping of question indices to factors (0-indexed)
  // Questions 0-14 are 7-point, questions 15-23 are 5-point
  const questionToFactor: QuestionToFactor = {
    0: 1, 1: 1, 2: 1,      // Factor 1: questions 1-3 (7-point)
    3: 2, 4: 2, 5: 2,      // Factor 2: questions 4-6 (7-point)
    6: 3, 7: 3, 8: 3,      // Factor 3: questions 7-9 (7-point)
    9: 4, 10: 4, 11: 4,    // Factor 4: questions 10-12 (7-point)
    12: 5, 13: 5, 14: 5,   // Factor 5: questions 13-15 (7-point)
    15: 6, 16: 6, 17: 6,   // Factor 6: questions 16-18 (5-point)
    18: 7, 19: 7, 20: 7,   // Factor 7: questions 19-21 (5-point)
    21: 8, 22: 8, 23: 8,   // Factor 8: questions 22-24 (5-point)
  };

  // Questions that should be reverse-scored (if any)
  const negativelyWeighted = new Set([4, 12]); // Adjust based on your survey logic
  ...
  const calculateFactorScores = (responses: number[]): Results => {
    // Initialize factor scores and counts
    const factorScores: FactorScores = {};
    const factorQuestionCounts: Record<number, number> = {};
    ...
    // Calculate normalized scores for each response
    for (let i = 0; i < responses.length; i++) {
      if (responses[i] === null) continue;
      ...
      if (fivePointIndices.has(i)) {
        // 5-point scale: normalize to 0-1
        normalizedScore = (responseValue - 1) / 4;
      } else {
        // 7-point scale: normalize to 0-1
        normalizedScore = (responseValue - 1) / 6;
      }
      
      // Apply negative weighting if needed
    ...
    return {
      ...
      topFactor: {
        number: topFactorNumber,
        name: factorNames[topFactorNumber],
        score: factorScores[topFactorNumber], // Use the normalized score (0-1)
        description: factorDescriptions[topFactorNumber],
      },
    };
  };
