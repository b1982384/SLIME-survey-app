...
const navigate = useNavigate()
  return (
    <div className = "welcome-container">
      ...
      <div className = "advertise-banner">Take our 24 question survey to find out your listener profile!</div>
